...
class OptionsFramework_Backup {
	...
	function register_admin_screen () {
		...
		$this->admin_page = add_theme_page(__( 'OptionsFramework Import / Export', 'OptionsFramework' ), __( 'Import / Export', 'OptionsFramework' ), 'edit_theme_options', $this->token, array( &$this, 'admin_screen' ) );
